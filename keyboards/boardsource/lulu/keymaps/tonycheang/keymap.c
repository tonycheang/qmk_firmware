 ...
 */
 [_DVORAK] = LAYOUT(
  ...
  OSM(MOD_LSFT),   KC_SCOLON,     KC_Q,           KC_J,            KC_K,    KC_X, _______,  _______,  KC_B,    KC_M,    KC_W,           KC_V,           KC_Z,           OSM(MOD_LSFT),
...
[_RSYM] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRACKET, KC_RBRACKET, KC_UNDS,  KC_BSLASH, _______,
                         _______, _______, _______, _______,          _______, _______, _______, _______
),
 ...
 */
  ...
  _______, _______,  KC_LEFT,       KC_DOWN,  KC_RIGHT,         KC_PGDOWN,                 _______, _______, _______, _______, _______, _______,
  ...
  switch (keycode) {
    case MCRO_TMUX_LEFT:
      if (record->event.pressed) {
        SEND_STRING(SS_LCTL(SS_TAP(X_A)) SS_DELAY(101) SS_TAP(X_O));
      }
      break;
